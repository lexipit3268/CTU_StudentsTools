...
### Giấy phép
Copyright (c) 2025 lexipit3268

Mọi quyền được bảo lưu. Mã nguồn này là tài sản riêng và được bảo mật. Không phần nào của dự án này được phép sử dụng, sao chép hoặc phân phối dưới bất kỳ hình thức nào mà không có sự cho phép trước bằng văn bản của tác giả.
...
Copyright (c) 2026 lexipit3268

All rights reserved. This source code is proprietary and confidential. No part of this project may be used, reproduced, or distributed in any form or by any means without the prior written permission of the author.
